...
var windowElements = document.querySelectorAll(".windows .win"); //ensemble des icones
...
var Window = /*#__PURE__*/function () {
  function Window(el, initX, initY, off) {
    ...
    this.setWindowPosition(); //bouton close
  ...
  _createClass(Window, [{
    ...
    value: function Close(e) {
      ...
      if (this.el.id == 'end') {
        ...
        this.el.remove();
        var windowElements = document.querySelectorAll(".windows .win"); //test du nombre de fenetres restantes
        //si aucune fenetre => fenetre de depart

        if (windowElements.length == 0) {
          console.log('well done');
          var doc = document.querySelector(".windows"); //console.log(doc)
    ...
    value: function Reduce(e) {
      ...
      if (!this.isReduced) {
        ...
        var rectangle = this.el.getBoundingClientRect(); //this.el.style.transition= 'transform 230ms ease-in-out';
    ...
    value: function Move() {
      ...
      if (reduced.length > 0) {
        ...
        redArray.forEach(function (red) {
          ...
          red.parentNode.style.transform = "translate3d(".concat(x1, "px, ").concat(window.innerHeight - 42, "px, 0)");
...
icons.forEach(function (ico) {
  ico.addEventListener("dblclick", function () {
    if (ico.id == 'txt') {
      document.querySelector('.windows').insertBefore(txtTab, document.querySelector(' .icon')); //document.querySelector('.windows').insertBefore(txtTab,document.querySelector(' .icon'));
